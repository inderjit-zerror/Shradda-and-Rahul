  ...
  return (
    ...
    >
      ...
      <div className="w-[80%] max-sm:w-full px-6 max-sm:px-[20px] flex flex-col gap-20 relative z-50">
        <h2
          className="text-center text-[4vw] Font_Header flex flex-col justify-center items-center max-sm:justify-start max-sm:mt-10"
          style={{ color: "#1F2B34", fontFamily: "'Cormorant Garamond', serif" }}
        >
          FAQ
        </h2>
        ...
        <div className="space-y-6 w-full">
          {faqs.map((faq) => (
            ...
            >
              ...
              >
                <span
                  className="tracking-wide uppercase text-[1.5rem] max-sm:text-[1.1rem] md:text-base"
                  style={{
                    color: "#1F2B34",
                ...
                >
                  ...
                  />
                  <span className="absolute inset-0 m-auto w-[7px] h-[7px]" style={{ backgroundColor: "#F5F2ED" }} />
                </span>
              </button>
