...
const itineraryData = [
  {
    ...
    description:
      "Kick off the celebrations with vibrant colors, music, and henna artistry. Enjoy refreshing drinks and light bites.",
    accent: "#C9A84C",
    icon: "✦",
    tag: "Day 01",
  },
  {
    ...
    description:
      "Join us for a joyful morning filled with laughter and traditions. Dress in yellow and enjoy the fun!",
    accent: "#E5C76B",
    icon: "✦",
    tag: "Day 02",
  },
  {
    ...
    description:
      "An evening of music, dance, and performances. Celebrate love and dance your heart out!",
    accent: "#C9A84C",
    icon: "✦",
    tag: "Day 02",
  },
  {
    ...
    time: "Baraat: 4:00 PM | Pheras: 6:30 PM",
    venue: "Heritage Palace",
    description:
      "Witness the sacred union as we tie the knot in a traditional ceremony.",
    accent: "#E5C76B",
    icon: "♦",
    tag: "Day 03",
  },
  {
    ...
    venue: "Heritage Palace Lawn",
    description:
      "Celebrate the newlyweds with dinner, music, and unforgettable moments.",
    accent: "#C9A84C",
    icon: "✦",
    tag: "Day 03",
  },
